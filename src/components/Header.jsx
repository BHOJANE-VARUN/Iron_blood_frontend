...
function Header({ setRange, setBlood, Blood, Range }) {
  const navigate = useNavigate();
  const handleBack = () => {
    localStorage.clear();
    navigate("/");
  };
  //  console.log(Blood,Range);
  return (
    <div className="px-12 w-full h-16 flex justify-between items-center">
      <button
        onClick={handleBack}
      ...
      <div className="flex w-[50%] h-full justify-evenly items-center">
        <div className="flex px-2 py-2 border border-gray-300 rounded-md bg-white focus:outline-none focus:ring-2 focus:ring-blue-500">
          <input
            value={Range}
        ...
        <select
          ...
          class="px-2 py-2 border border-gray-300 rounded-md bg-white focus:outline-none focus:ring-2 focus:ring-rose-500"
        >
